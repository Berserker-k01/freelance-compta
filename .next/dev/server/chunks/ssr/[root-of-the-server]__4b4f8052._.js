...
function UserRegisterPage() {
    ...
    const handleRegister = async (e)=>{
        ...
        setError(null);
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/auth/users/`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            if (res.ok) {
                ...
                const loginRes = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE_URL"]}/auth/token`, {
                    method: "POST",
                    headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4b4f8052._.js.map