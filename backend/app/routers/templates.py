...
async def upload_dynamic_template(
    ...
    KNOWLEDGE_BASE = {
        ...
        "matériel, mobilier et actifs biologiques": [(3, "241*, 242*, 243*, 244*, 245*, 246*, 247*, 248*"), (4, "ABS(284*)")],
        ...
        "résultat net de l'exercice": [(4, "SIGNED(13*)")],
        ...
        "bâtiments": [(3, "231*, 232*, 233*, 234*, 235*, 236*, 237*, 238*"), (4, "ABS(283*)")],
